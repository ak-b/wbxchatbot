...
def search():
    ...
    """
    #DC= {'SJC02':'sj','DFW01':'tx','IAD02':'ta','JFK01':'ny','LHR03':'ln','AMS01':'am','SIN01':'sg','NRT03':'jp','SYD01':'sy'}
    DC = {'SJC02':'sj','DFW01':'tx'}
    for base,uvalue in DC.items():
        url = "https://clp{}-infra.webex.com/esapi/*-infra-*/_search".format(uvalue)
        ...
        if response.status_code == 200:
            print(" Kibana Embryonic Connections Logs in {}\n".format(base))
            for i in range(2):
            ...
            print("Sorry! Unable to connect to ES Database in {}\n".format(base))
